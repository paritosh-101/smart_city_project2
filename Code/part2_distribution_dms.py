...
data_short = data_short[data_short["Alert"].str.contains("dms_")].reset_index()
...
fig_3.write_image("../Plots/dms_ax_lat_long_alert.png", scale=3)
...
fig_4.write_image("../Plots/dms_ax_lat_long_vehicle.png", scale=3)
...
fig_5.write_image("../Plots/dms_ax_speed_vehicle_alert.png", scale=3)
...
fig_6.write_image("../Plots/dms_ax_speed_datetime_alert.png", scale=3)
...
fig_7.write_image("../Plots/dms_ax_datetime_vehicle_alert.png", scale=3)
